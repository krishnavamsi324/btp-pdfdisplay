		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#pdfdisplayworkflowuimodule-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pdfdisplayworkflowuimodule-display": {
								"semanticObject": "pdfdisplayworkflowuimodule",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pdfdisplay.workflowuimodule",
									"url": sap.ui.require.toUrl("pdfdisplay/workflowuimodule")
								}
							}
						}
					}
